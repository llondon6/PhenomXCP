...
1. Load simulation 
2. Compute TD Strain Co-Precessing Frame 
...
for a in A:
    ...
    frame['cp-y-fd'] = frame['init-j'].__calc_coprecessing_frame__( transform_domain='fd', kind='strain',select_lm_list=cpframe_select_lm )
    frame['cp-y-td'] = frame['init-j'].__calc_coprecessing_frame__( transform_domain='td', kind='strain',select_lm_list=cpframe_select_lm )
